...
public class MenuState implements ActionListener {
	...
	creditsButton.setBounds(
		X_POSITION, 
		Y_POSITION + Y_OFFSET * 3, 
		BUTTON_WIDTH, 
		BUTTON_HEIGHT
	);
	
	startButton.setIcon(
		new ImageIcon(Assets.btn_start[0])
	);
	tutorialButton.setIcon(
		new ImageIcon(Assets.btn_tutorial[0])
	);
	descriptionButton.setIcon(
		new ImageIcon(Assets.btn_description[0])
	);
	creditsButton.setIcon(
		new ImageIcon(Assets.btn_credits[0])
	);
	
	startButton.setPressedIcon(
		new ImageIcon(Assets.btn_start[1])
	);
	tutorialButton.setPressedIcon(
		new ImageIcon(Assets.btn_tutorial[1])
	);
	descriptionButton.setPressedIcon(
		new ImageIcon(Assets.btn_description[1])
	);
	creditsButton.setPressedIcon(
		new ImageIcon(Assets.btn_credits[1])
	);	
